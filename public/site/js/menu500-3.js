...
function openMenu(){
    ...
    scriptMenu.innerHTML=`<div><a href="#sigCommentsBlock">Отзовы</a><a href="https://fonolog.ru/Public-Offer">Публичная оферта</a><a href="https://fonolog.ru/Privacy-Policy">Политика конфиден<wbr>циальности</a></div>`;
